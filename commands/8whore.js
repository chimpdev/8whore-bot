...
module.exports = {
  ...
  execute: async interaction => {
    try {
      ...
      placeText(ctx, 170, 180, 240, 4, interaction.options.getMember('user') ? interaction.options.getMember('user').displayName : interaction.options.getUser('user').username, 25, 'Arial', '#ffffff', 185, 185 + 25);
